# Modified for 16-bit regs based on https://github.com/NationalSecurityAgency/ghidra/blob/master/Ghidra/Features/Base/ghidra_scripts/mark_in_out.py
...
for instruction in instructions:
    if instruction.mnemonicString == "IN":
        ...
        if prevInstruction.mnemonicString in ["MOV", "XOR"]:
            # did we move an absolute address into DX?
            if (prevInstruction.getOperandType(1) & SCALAR) != 0:
                ...
                if (prevInstruction.getOperandType(0) & REGISTER) != 0:
                    ...
                    if register.getBaseRegister().name == "DX":
                        # hooray!
        ...
        if prevInstruction.mnemonicString in ["MOV", "XOR"]:
            ...
            if (prevInstruction.getOperandType(1) & SCALAR) != 0:
                ...
                if (prevInstruction.getOperandType(0) & REGISTER) != 0:
                    ...
                    if register.getBaseRegister().name == "DX":
                    ...
                    elif register.getBaseRegister().name == "AX":
                        ...
                        try:
                            ...
                            if prevInstr.mnemonicString in ["MOV", "XOR"]:
                                # did we move an absolute address into EDX?
